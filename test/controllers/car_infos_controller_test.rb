...
class CarInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create car_info' do
    assert_difference('CarInfo.count') do
      post car_infos_url,
           params: { car_info: { car_lease_info: @car_info.car_lease_info, car_mark: @car_info.car_mark,
                                 car_number: @car_info.car_number, car_type: @car_info.car_type, misc_info: @car_info.misc_info, user_id: @car_info.user_id } }
    end
